...
public class ToDeliverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderService.riderOrders(1,3).enqueue(new Callback<List<Order>>() {
            ...
            holder.setItemClickListener(new ItemClickListener() {
                ...
                public void onItemClick(View v, final int pos) {
                    ...
                    alert.setNegativeButton("Reached", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            orderService.setRiderRequestStatus(1,4,orderList.get(pos).getOrderId()).enqueue(new Callback<ApiResponse>() {
                                @Override
